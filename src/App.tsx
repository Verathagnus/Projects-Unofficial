    ...
    lg:flex-row"
      ...
      <section id="tabs">
        <div className="container relative mx-auto my-6 mb-32 mt-12 px-6">
          ...
          {/* Tabs Flex Container */}
          <div className="flex flex-col justify-center max-w-xl mx-auto mb-6 border-b md:border-b-0">
            {/* Tab 1  */}
            <div className="flex justify-center text-center cursor-pointer text-gray-600 border-b md:border-b-0">
              Simple BOokmarking
            </div>
          ...
          <div id="panels" className="container mx-auto">
            ...
            <div className="flex flex-col py-5 md:flex-row md:space-x-7 panel panel-1">
              ...
              <div className="flex justify-center md:w-1/2">
                <img src="src/assets/illustration-features-tab-1.svg" alt="" className="relative z-10" />
              </div>
              {/* Panel Content  */}
