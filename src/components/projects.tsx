...
const Projects = () => {
    ...
    function  Square1(){
        ...
        >
            <div className="flex justify-center">
              <img src="public/assets/apexsite.png" alt="Apex site" />
            </div>
    ...
    function Square2 () {
      ...
      >
          <div className="flex justify-center">
            <img src="public/assets/apexsite.png" alt="Chrome Image" />
          </div>
    ...
    function Square3(){
      ...
      >
          <div className="flex justify-center">
            <img src="public/assets/apexsite.png" alt="Ganasuraksha" />
          </div>
